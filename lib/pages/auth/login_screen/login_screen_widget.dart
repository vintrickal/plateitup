...
class _LoginScreenWidgetState extends State<LoginScreenWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().signupWasTapped = false;
      });
    });

    _model.emailAddressSignTextController ??= TextEditingController();
    _model.emailAddressSignFocusNode ??= FocusNode();
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.emailAddressSignTextController,
                              focusNode: _model.emailAddressSignFocusNode,
                              autofocus: false,
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                final user = await authManager.signInWithEmail(
                                  context,
                                  _model.emailAddressSignTextController.text,
                                ...
                                _model.pairedUserCollectionLogin =
                                ...
                                if ((_model.pairedUserCollectionLogin !=
                                        null) ==
                                    true) {
                                  setState(() {
                                ...
                                setState(() {
                                  FFAppState().pairedUserCollection = _model
                                      .pairedUserCollectionLogin?.reference;
                                });
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await currentUserReference!
                                            ...
                                            displayName:
                                                functions.limitCharacterFunc(
                                                    currentUserDisplayName),
                                          ));

                                          var savedRecipeRecordReference =
                                              SavedRecipeRecord.collection.doc(
                                                  currentUserReference!.id);
                                          await savedRecipeRecordReference
                                              .set(createSavedRecipeRecordData(
                                            userId: currentUserReference,
                                          ));
                                          _model.savedRecipeList =
                                              SavedRecipeRecord.getDocumentFromData(
                                                  createSavedRecipeRecordData(
                                                    userId:
                                                        currentUserReference,
                                                  ),
                                                  savedRecipeRecordReference);
                                          setState(() {
                                            FFAppState().signupWasTapped =
                                                false;
